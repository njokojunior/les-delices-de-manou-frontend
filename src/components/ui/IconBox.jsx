  ...
  return (
    <div className="bg-white flex flex-col items-center gap-0.5 md:gap-1 lg:gap-4">
      <div className="relative">
        ...
        />
        <p className="absolute bg-rose-400 text-[9px] w-4 h-4 text-white  sm:w-5 sm:h-5 lg:w-7 lg:h-7  top-0 right-0 rounded-full flex items-center  justify-center">
          {props.count}
        </p>
      </div>
      ...
      <p className="text-xs text-center text-stone-500 md:text-sm/5 ">
        {props.description}
      </p>
    </div>
  );
